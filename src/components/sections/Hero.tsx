...
export default function Hero() {
    return (
      <section className={`${styles.heroSection} w-full flex items-center justify-center bg-[linear-gradient(270deg,#FFFFFF_36%,#9D8BFF_86%)] px-6 md:px-20`} style={{marginTop: "30px"}}>
